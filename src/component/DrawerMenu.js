...
class Index extends React.Component {
    ...
    render() {
        ...
        const headerTitle = collapsed ? null : <div className='drawer-header-text-container'>
            <label className='drawer-header-text'>社区社交系统</label>
        ...
        return (
            <Sider trigger={null} collapsed={collapsed} collapsible onCollapse={this.onCollapse}>
                <div className='drawer-header'>
                    <img className='drawer-logo' alt="logo" src='https://download-sdk.oss-cn-beijing.aliyuncs.com/downloads/IMDemo/avatar/Image1.png'/>
                    {headerTitle}
                </div>
                {this.menu()}
            </Sider>
